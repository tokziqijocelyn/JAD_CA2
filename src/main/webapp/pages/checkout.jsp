							...
							<div class="row g-0">
								<div class="">
									<div class="p-5">
										...
										<a class="btn btn-primary" href="http://localhost:8080/JAD_CA2/pages/home.jsp">Shop</a>
										...
										<div class="row mb-4">
											...
											<div class="col-md-3 d-flex justify-content-end align-items-center">
												<div class="input-group">
													<h6 class="text-black mb-0"><%=cartItem.getQuantity()%> qty</h6>
												</div>
											</div>
											<div class="col-md-3 d-flex justify-content-end align-items-center">
												<h6 class="mb-0">
									...
									<div class="p-5">
										...
										<div class="d-flex justify-content-between mb-5">
											...
											<div>
												...
												<h5>
													Unit No.:  <%=customer.getUnit_no() %>
												</h5>
												<h5>
													Block:  <%=customer.getBlock() %>
												</h5>
												<h5>
													Postal Code:  <%=customer.getPostal_code() %>
												</h5>
											</div>
