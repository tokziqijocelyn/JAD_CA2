							...
							<div class="row g-0">
									...
									<div class="p-5">
										...
										<div class="row mb-4">
											<div class="col-md-2 col-lg-2 col-xl-2">
												<img src="<%=request.getContextPath() + cartItem.getImg()%>" class="img-fluid rounded-3" alt="Book image">
											</div>
											<div class="col-md-4">
											...
											<div class="col-md-3 d-flex justify-content-end align-items-center">
												<div class="input-group">
													...
													<form action="/JAD_CA2/updateCart" method="POST">
														<input type="submit" id="minus" name="arith" class="btn" value="-"> 
														<input type="hidden" name="book_id" value="<%=cartItem.getBook_id()%>"> 
														<input type="hidden" name="cust_id" value="<%=cust_id%>">
														<input type="number" value="<%=cartItem.getQuantity()%>" name="qty" min="1" max="<%=cartItem.getInventoryLeft()%>" readonly min="1" max="<%=cartItem.getInventoryLeft()%>" />
														<input type="submit" id="plus" name="arith" class="btn" value="+">
													</form>
												</div>
											</div>
											<div class="col-md-3 d-flex justify-content-end align-items-center">
												...
												<form action="/JAD_CA2/deleteCart">
													<input type="hidden" name="book_id" value="<%=cartItem.getBook_id()%>">
													<input type="hidden" name="cust_id" value="<%=cust_id%>"> 
													<input type="submit" name="delete" value="X" class="btn m-2">
												</form>
										...
										<a class="btn btn-primary" href="http://localhost:8080/JAD_CA2/pages/home.jsp">Back to Shop</a>
								...
								<div class="col-lg-7 bg-grey">
									...
									<div class="p-5">
										...
										<a class="btn btn-primary" href="http://localhost:8080/JAD_CA2/pages/checkout.jsp">Proceed to checkout</a>
